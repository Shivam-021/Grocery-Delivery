...
export { assets, categories, footerLinks, features, dummyProducts, dummyAddress, dummyOrders };
export default assets;
export { default as potato_image_1 } from "./potato_image_1.png";
export { default as potato_image_2 } from "./potato_image_2.png";
export { default as potato_image_3 } from "./potato_image_3.png";     
